...
export async function AppShell({
    ...
    return (
      <div className="app-shell">
        <aside className="sidebar">
          <Link href="/saas-admin" className="brand">
            Clyra<span>Health</span>
          </Link>

          <div className="sidebar-meta">
            <strong>Administração SaaS</strong>
          </div>
  ...
  const trialWarning =
    ...
    subscription.trialEnds
      ? trialDaysRemaining(subscription.trialEnds)
      : null;
      ...
      <main className="content">
        {trialWarning !== null &&
          trialWarning <= 5 && (
            ...
            >
              {trialWarning > 0
                ? `Seu teste gratuito termina em ${trialWarning} dia(s).`
